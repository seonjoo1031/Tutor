...
class PastNavibar extends Component {
    ...
    if (Platform.OS === 'ios') {
      return (
        <View style={{ height: 65 }}>
          ...
          <View style={{ backgroundColor: '#7a5de8', flex: 1, justifyContent: 'center', alignItems: 'center' }} />
            ...
            <TouchableHighlight style={{ position: 'absolute', top: 29, left: 0, right: 0, width: 200, height: 50 }} underlayColor='transparent' onPress={() => { Actions.pop(); }} >
              <MIcon name='chevron-left' size={24} color='#f9f9f4' />
            </TouchableHighlight>
